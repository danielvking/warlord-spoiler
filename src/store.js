...
function createKeywordRegex(additionalKeywords) {
  return function (state) {
    ...
    // Basic keywords
    let keywords = (additionalKeywords || []).concat(["Limited Spend Order:", "Limited Roll Order:", "Roll Order:", "Roll Spend Order:", "Limited Order:", "Spend Order:", "Destroy Order:", "Order:", "Limited Spend React:", "Spend React:", "Limited React:", "Enter React:", "Death React:", "React:"]);
